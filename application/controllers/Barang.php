...
class Barang extends CI_Controller
{
    ...
    public function tambah_barang()
    {
        if ($this->session->userdata('akses') == '1') {
            ...
            $this->m_barang->simpan_barang($kobar, $barcode, $nabar, $kat, $satuan, $harpok, $harjul, $harjul_grosir, $stok, $min_stok);
    ...
    public function edit_barang()
    {
        if ($this->session->userdata('akses') == '1') {
            ...
            $stok = $this->input->post('stok');
            $min_stok = $this->input->post('min_stok');
            $this->m_barang->update_barang($kobar, $barcode, $nabar, $kat, $satuan, $harpok, $harjul, $harjul_grosir, $stok, $min_stok);
